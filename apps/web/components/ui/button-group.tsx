...
function ButtonGroupText({
    ...
    return useRender({
        ...
        props: mergeProps<'div'>(
            {
                className: cn(
                    "flex items-center gap-2 rounded-md border border-border bg-elevated-surface px-2.5 text-sm/relaxed font-medium text-text-primary [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
                    className,
                ),
            },
            props,
