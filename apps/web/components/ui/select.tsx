...
function SelectItem({
    ...
    return (
        <SelectPrimitive.Item
            ...
            className={cn(
                "relative flex min-h-8 w-full cursor-default items-center gap-2 rounded-md px-2 py-1 text-sm/normal outline-hidden select-none focus:bg-border focus:text-text-primary data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
                className,
            )}
            {...props}
        >
...
function SelectScrollUpButton({
    ...
    return (
        <SelectPrimitive.ScrollUpArrow
            ...
            className={cn(
                "top-0 z-10 flex w-full cursor-default items-center justify-center bg-elevated-surface py-1 [&_svg:not([class*='size-'])]:size-3.5",
                className,
            )}
            {...props}
        >
...
function SelectScrollDownButton({
    ...
    return (
        <SelectPrimitive.ScrollDownArrow
            ...
            className={cn(
                "bottom-0 z-10 flex w-full cursor-default items-center justify-center bg-elevated-surface py-1 [&_svg:not([class*='size-'])]:size-3.5",
                className,
            )}
            {...props}
        >
